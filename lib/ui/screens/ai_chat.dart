                    ...
                    if (title.isNotEmpty)
                      MarkdownBody(
                        ...
                        styleSheet: MarkdownStyleSheet(
                          p: ArabicFontHelper.getChangaTextStyle(
                            context,
                            fontSize: 18,
                          ...
                          strong: ArabicFontHelper.getChangaTextStyle(
                            context,
                            fontSize: 18,
                          ...
                          em: ArabicFontHelper.getChangaTextStyle(
                            context,
                            fontSize: 18,
                            fontWeight: FontWeight.w400,
                            color: isUserMessage
                          ...
                          a: ArabicFontHelper.getChangaTextStyle(
                            context,
                            fontSize: 18,
                            fontWeight: FontWeight.w400,
                            color: isUserMessage
